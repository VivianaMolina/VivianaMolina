...
<div style="display: flex; align-items: center;">
  ...
  <a style="margin-left: 10px;" href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=poppins&weight=100&size=25&pause=1000&width=435&lines=Hi+there!+I'm+Viviana" alt="Typing SVG"
         style="filter: invert(27%) sepia(98%) saturate(747%) hue-rotate(185deg) brightness(95%) contrast(90%);" />
  </a>
</div>
...
- 📈 I’ve been actively working on projects that apply Python for Data Science, including data collection, data preparation, exploratory data analysis (EDA), descriptive statistics, and statistical inference. These experiences have deepened my ability to transform raw data into actionable insights.
- 📈 I am currently diving into Cloud and Machine learning models: I've worked on projects using unsupervised and supervised machine learning, like clustering, classification, and regression. I’ve seen how powerful deep learning can be, especially for working with images and text. I’ve also explored big data basics, learning how to handle large datasets with scalable tools and cloud platforms.
